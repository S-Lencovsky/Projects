...
const Sound = () => {
    ...
    useEffect(() => {
        ...
        const consentTime = localStorage.setItem('consentTime', new Date().toString());
    ...
    return ( <div className="fixed top-4 right-2.5 xs:right-4 z-50 group">
        ...
        <audio ref={audioRef} loop >
            <source src="/audio/birds39-forest-20772.mp3" type="audio/mpeg" /> Oopsy!
      ...
      >
        {
         isPlaying ? <Volume2 className='w-full h-full text-foreground group-hover:text-accent' strokeWidth={1.5} />
        :
